...
<sdf version="1.9">
  <world name="ugv_arena">
    ...
    <!-- TRUE GOAL (gold) cell(5,0) center=(11,1) — large floor + north wall stripe -->
    <!-- NO south wall (GOAL sign is there), NO east wall (boundary wall is there) -->
    <!-- Only north wall stripe so robot sees gold approaching from cell(5,1) -->
    <model name="true_goal"><static>true</static>
      ...
      <link name="l">
        ...
        <visual name="north_stripe"><geometry><box>
